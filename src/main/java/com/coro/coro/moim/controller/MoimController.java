...
public class MoimController implements MoimControllerDocs {
    ...
    @GetMapping("/{id}")
    @Override
    public APIResponse getDetailed(@PathVariable("id") final Long moimId, @AuthenticationPrincipal final User user) throws IOException {
    ...
    @Override
    public APIResponse updateMoimMember(@PathVariable("moimId") final Long moimId,
    ...
    @Override
    public APIResponse deportMember(@PathVariable(name = "moimId") final Long moimId,
                                    @ModelAttribute(name = "moimMember") final Long moimMemberId,
                                    @AuthenticationPrincipal final User user) {
